...
function Home() {
  const leftAnimationProps = useSpring({
    ...
    config: { tension: 170, friction: 40 }, // Increased friction for slower animation
    delay: 200,
  });
  ...
  return (
    <div className="w-full h-screen flex justify-center">
      <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-auto gap-4 w-full max-w-screen-lg h-5/6 p-4 rounded-lg">
        <animated.div style={leftAnimationProps} className="col-span-1 md:col-span-2 row-span-2 bg-neutral-800 p-4 flex flex-col justify-start items-start rounded-lg w-full">
        ...
        <animated.div style={rightAnimationProps} className="hidden md:block row-span-3 col-span-1 md:col-start-3 bg-neutral-800 items-center justify-center rounded-lg overflow-hidden w-full">
        ...
        <animated.div style={leftAnimationProps} className="col-span-1 md:col-span-2 row-span-4 md:col-start-2 md:row-start-5 bg-neutral-800 p-4 flex flex-col items-start justify-start rounded-lg w-full">
          ...
          <ul className="text-gray-400 text-lg list-none">
            ...
            <li className="mb-2">
              ...
              <p className="text-gray-400">Aalborg University - 2024 to present</p>
        ...
        <animated.div style={leftAnimationProps} className="row-span-5 col-span-1 md:col-start-1 md:row-start-4 bg-neutral-800 p-4 flex flex-col items-start justify-start rounded-lg w-full">
